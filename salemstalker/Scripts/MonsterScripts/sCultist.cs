...
public partial class sCultist : Monster3d
{
	...
	public override void _Ready()
	{
	   // -- Variables -- //
		...
		AttackSpeed = 4f;         // The time between its attacks
		...
		AgroFOV = 10f;          	// The vision FOV of the monster
		AgroLength = 10f;          // The detection length of the monsters vision
		WalkRange = 5f;	         	// The noise range monsters hear the player walking
